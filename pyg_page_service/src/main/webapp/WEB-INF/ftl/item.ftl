...
<body ng-app="pyg" ng-controller="itemController" ng-init="loadSku()">
	<!-- 头部栏位 -->
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${category1Name}</a>
					</li>
					<li>
						<a href="#">${category2Name}</a>
					</li>
					<li>
						<a href="#">${category3Name}</a>
					</li>
				</ul>
			</div>
			<!--product-info-->
							...
							<#list specList as spec>
								<dl>
									...
									<#list spec.attributeValue as value>
										<dd><a href="javascript:;" class="{{isSelectedSpec('${spec.attributeName}','${value}')?'selected':''}}"  ng-click="selectSpec('${spec.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
								</dl>
							</#list>
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" value="1" minnum="1" ng-model="num" class="itxt" />
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a  ng-click="addGoodsToCartList()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
