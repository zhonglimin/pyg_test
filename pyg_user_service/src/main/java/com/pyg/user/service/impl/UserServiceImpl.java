...
public class UserServiceImpl implements UserService {
    ...
    public void sendCode(String phone) {
        ...
        System.out.println("生成的验证码是：" + numeric);

        //2. 将验证码保存到redis中
//        redisTemplate.boundHashOps("checkCode").put(phone,numeric);
        redisTemplate.boundValueOps(phone).set(numeric,1, TimeUnit.MINUTES);
...
//                String param = "{'code':'"+numeric+"'}";
	...
	public boolean checkCode(String smscode, String phone) {
        ...
        Object o = redisTemplate.boundValueOps(phone).get();
        if(o == null){
            return false;
        }
